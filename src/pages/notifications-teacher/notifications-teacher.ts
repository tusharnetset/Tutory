...
import { NavController, NavParams,ModalController ,ToastController, Platform, AlertController } from 'ionic-angular';
...
@Component({
  selector: 'page-notifications-teacher',
  templateUrl: 'notifications-teacher.html',
})
export class NotificationsTeacherPage {
  ...
  getNotification(){
    ...
    this.spinner.show();
    this.tutorservices.getNotificationsApi(notificationData).then((result) => {
      console.log(result);
      this.spinner.hide();
      this.data1 = result;
